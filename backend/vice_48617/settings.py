"""
Django settings for vice_48617 project.
...
WSGI_APPLICATION = 'vice_48617.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Vice Support <support@vice-48617.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vice_48617 API",
    "DESCRIPTION": "API documentation for vice_48617 App",
    "VERSION": "v1",
}
